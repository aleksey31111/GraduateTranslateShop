...
from shop import CatalogListCMSApp, CatalogSearchApp, OrderApp, PasswordResetApp
from shop import CMSPagesFilterBackend


class CatalogListApp(CatalogListCMSApp):
    def get_urls(self, page=None, language=None, **kwargs):
        from shop import ProductSearchViewMixin
        from shop import AddToCartView, ProductListView, ProductRetrieveView
        from shop import AddFilterContextMixin
